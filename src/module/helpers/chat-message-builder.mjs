export class ChatMessageBuilder {
  ...
  static createDamageApplyButton(damage, penetration, location, targetId, damageType = 'Impact', isPrimitive = false) {
    return `<button class="apply-damage-btn" data-damage="${damage}" data-penetration="${penetration}" data-location="${location}" data-target-id="${targetId}" data-damage-type="${damageType}" data-is-primitive="${isPrimitive}">Apply Damage</button>`;
  }
