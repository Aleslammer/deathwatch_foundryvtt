 ...
 * Simplified version of CharacterDataPreparer — characteristics labels, skills, wound color.
 */
export class NPCDataPreparer {
  /**
   * Prepare all NPC data for sheet display.
