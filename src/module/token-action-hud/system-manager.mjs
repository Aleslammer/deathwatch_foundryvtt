...
export function initializeSystemManager(coreModule) {
  SystemManager = class SystemManager extends coreModule.api.SystemManager {
     ...
     */
    getActionHandler() {
      console.log('[TAH SystemManager] getActionHandler called');
      console.log('[TAH SystemManager] ActionHandler class:', ActionHandler);
      const handler = new ActionHandler();
      console.log('[TAH SystemManager] Created handler:', handler);
      return handler;
    }
    ...
    getRollHandler(rollHandlerId) {
      console.log('[TAH SystemManager] getRollHandler called with id:', rollHandlerId);
      console.log('[TAH SystemManager] RollHandler class:', RollHandler);
    ...
    getAvailableRollHandlers() {
      console.log('[TAH SystemManager] getAvailableRollHandlers called');
      const handlers = {
        core: 'Deathwatch'
      };
      console.log('[TAH SystemManager] Returning handlers:', handlers);
      return handlers;
    }
    ...
    async registerDefaults() {
      console.log('[TAH SystemManager] registerDefaults called');
      ...
      console.log('[TAH SystemManager] Returning defaults:', JSON.stringify(defaults, null, 2));
      return defaults;
    }
  };
}
