...
const FACTIONS = [
  {
    ...
    files: {
      ...
      "trygon.json":                    { num: "17", type: "enmy" },
      "trygon-prime.json":              { num: "18", type: "enmy" },
      "tyranid-warrior-prime.json":     { num: "19", type: "enmy" },
      "tyrant-guard.json":              { num: "20", type: "enmy" },
      "venomthrope.json":               { num: "21", type: "enmy" },
      "zoanthrope.json":                { num: "22", type: "enmy" },
